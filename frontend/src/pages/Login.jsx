...
export default function Login({ setPage, setVerificationEmail }) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-dark-bg p-4 transition-colors duration-300">
      <div className="w-full max-w-md bg-white dark:bg-dark-card border border-slate-200 dark:border-dark-border rounded-2xl shadow-xl overflow-hidden p-8 relative">
        ...
        <div className="flex flex-col items-center mb-8 relative">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-slate-800 dark:text-white">Gaga Connect</h2>
          <p className="text-sm text-slate-500 dark:text-dark-muted mt-2">Sign in to your enterprise chat workspace</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="block text-sm font-semibold text-slate-600 dark:text-dark-muted">Password</label>
              <button
                type="button"
